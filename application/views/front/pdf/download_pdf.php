			...
			$(function(){
				...
				$("#filter-date").change(
					function(){
						...
						$.ajax({
							url:"<?php echo base_url();?>index.php/berita/get_filter_pdf/",
							cache:false,
							data: {
							   filter : convdate,
							   kanal : kanal
							...
							success:function(result){
								...
								$.each(result, function(i, data){
									$('#grid-box-index .autor-list').append('<li>'+
										'<a href="'+data.post_pdfl+'" style="text-decoration:none;">'+
										'<div class="autor-box padding-full-10">'+
											'<div class="autor-content margin-left-0">'+
												'<div style="color:#FD8E23"><span class="padding-right-10">'+data.category_name+'</span><i class="fa fa-clock-o margin-right-5 padding-left-10" style="border-left:1px dotted #777;"></i>'+data.post_modify_date.substr(8,2)+" "+formatMonth(data.post_modify_date.substr(5,2).valueOf()-1)+" "+data.post_modify_date.substr(0,4)+" "+data.post_modify_date.substr(11,5)+'</div>'+
												'<h4><span>'+data.post_title+'</span></h4>'+
											'</div>'+
										'</div>'+
										'</a>'+
									'</li>');
						...
						<div class="block-content">
							...
							<div class="grid-box" id="grid-box-index">
								...
								<?php foreach($get_index->result() as $popo){?>
									<li>
										<a href="<?php echo $popo->post_pdf;?>" style="text-decoration:none;">
										<div class="autor-box padding-full-10">
											<div class="autor-content margin-left-0">
