...
<head>
    <!-- Meta tags-->
    <meta charset="utf-8">
    <meta property="fb:app_id" content="298525293919660"/>
...
<script>
	$(function() {
		$('#login-act').click(function(){
			 ...
			 $.ajax({
				url:"<?php echo base_url();?>index.php/berita/get_validation_login/",
				cache:false,
				data: {
				   username : username,
				   password : password
		...
		$('#forget-act').click(function(){
			 ...
			 $.ajax({
				url:"<?php echo base_url();?>index.php/berita/get_forget_account/",
				cache:false,
				data: {
		...
		$('#reg-act').click(function(){
			 ...
			 $.ajax({
				url:"<?php echo base_url();?>index.php/berita/get_add_account/",
				cache:false,
				data: {
				   name_reg : name_reg,
				   email_reg : email_reg,
					...
					<div  class="col-xs-6 col-sm-6 col-md-6">
						...
						<div>
							...
							if($this->uri->segment(4) != ''){
							    echo base_url().'index.php/berita/loginFacebook/'.$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/';
							}else if($this->uri->segment(2) == '' or $this->uri->segment(2) == null){
							    echo base_url().'index.php/berita/loginFacebook/'.$this->uri->segment(1).'/none/none/none/';
							}else if($this->uri->segment(3) == '' or $this->uri->segment(3) == null){
							    echo base_url().'index.php/berita/loginFacebook/'.$this->uri->segment(1).'/'.$this->uri->segment(2).'/none/none/';
							}else{
							    echo base_url().'index.php/berita/loginFacebook/'.$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/none/';
							}
							//echo $login_url;
						...
						<div>
							<a href="<?php 
							if($this->uri->segment(4) != ''){
							    echo base_url().'index.php/berita/loginGoogle/'.$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/';
							}else if($this->uri->segment(2) == '' or $this->uri->segment(2) == null){
							    echo base_url().'index.php/berita/loginGoogle/'.$this->uri->segment(1).'/none/none/none/';
							}else if($this->uri->segment(3) == '' or $this->uri->segment(3) == null){
							    echo base_url().'index.php/berita/loginGoogle/'.$this->uri->segment(1).'/'.$this->uri->segment(2).'/none/none/';
							}else{
							    echo base_url().'index.php/berita/loginGoogle/'.$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/none/';
							}
							//echo $login_url;
							//echo base_url().'index.php/berita/loginFacebook/'.$url_d;
