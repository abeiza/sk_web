	...
	<script>
		function loadReaction(){
			var url = '<?php echo $this->uri->segment(3);?>';
			 $.ajax({
				url:"<?php echo base_url();?>index.php/berita/get_reaction_photo/",
				cache:false,
				data: {
				   url : url
				},
		...
		function loadCommentPost(){
			var url = '<?php echo $this->uri->segment(3);?>';
				 $.ajax({
					url:"<?php echo base_url();?>index.php/berita/get_comment_photo/",
					cache:false,
					data: {
					   url : url
					},
	...
	<script>
		$(function() {
			...
			$('#senang-box').click(function(){
				var id_post = $("#post").val();
				 $.ajax({
					url:"<?php echo base_url();?>index.php/berita/set_reaction_photo/",
					cache:false,
					data: {
					   reac : 'REA00001',
					   post : id_post
		...
		<div id="content-shared">
			<div class="sosmed-fixed">
				<ul>
					<li style="background:#1854dd;color:#fff;"><div style="width:100%;height:100%;margin:auto;display:flex;text-align:center;" data-href="<?php echo base_url().'index.php/berita/foto_detail/'.$this->uri->segment(3);?>" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="facebook customer share" style="text-decoration:none;color:#fff;width:100%;display:flex;" class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fm.suarakaryanews.com%2Findex.php%2Fberita%2Ffoto_detail%2F<?php echo rawurlencode($this->uri->segment(3));?>&amp;src=sdkpreparse"><span class="fa fa-facebook fa-2x"></span></a></div></li>
					...
					<li style="background:#f14133;color:#fff;"><a style="width:100%;height:100%;text-align:center;display:flex;color:#fff;text-decoration:none;" class="google customer share" href="https://plus.google.com/share?url=<?php echo rawurlencode('http://m.suarakaryanews.com/index.php/berita/foto_detail/'.$this->uri->segment(3));?>" onclick="javascript:window.open(this.href,
		...
		<section class="block-wrapper">
			<div class="container">
				<div class="row"  id="block-container">
					<div class="col-xs-7 col-sm-8 col-md-9 artikel-desc">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 artikel-desc" style="background-color:#222;">
								<!-- block content -->
								<div class="block-content">
									<!-- single-post box -->
									<div class="single-post-box">
										<!-- galery box -->
										<div class="galery-box" style="padding:0;">

											<div class="title-section">
												<h1 style="text-transform:none;"><span><?php echo $title_main;?></span></h1>
											</div>
											
											<ul class="slider-call2">
												<?php 
												$query = $this->db->query("select pict_detail_url from sk_photo_detail where ref_pict_id = '".$pict_id."' order by ObjectID");
												foreach($query->result() as $pd1){
												?>
												<li><img src="<?php echo base_url();?>uploads/pict/original/<?php echo $pd1->pict_detail_url;?>" alt=""/></li>
												<?php 
												}
												?>
											</ul>
											<div id="bx-pager2">
												...
												$index = 0;
												$query = $this->db->query("select pict_detail_url from sk_photo_detail where ref_pict_id = '".$pict_id."' order by ObjectID");
												foreach($query->result() as $pd2){
												?>
												<a data-slide-index="<?php echo $index;?>" href=""><img src="<?php echo base_url();?>uploads/pict/original/<?php echo $pd2->pict_detail_url;?>" alt=""/></a>
												<?php 
													$index++;
												}
												?>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 artikel-desc">
								...
								<div class="block-content">
									<!-- single-post box -->
									<div class="single-post-box">
										<div class="title-post margin-top-10 padding-full-0">
											<p style="font-size:12px;"><?php echo $short_main;?></p>
											<ul class="post-tags">
										...
										<div class="share-post-box">
        									...
        									<!-- Place this tag in your head or just before your close body tag. -->
        										<li><div data-href="<?php echo base_url().'index.php/berita/foto_detail/'.$this->uri->segment(3);?>" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="facebook customer share" class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fsuarakaryanews.com%2Findex.php%2Fberita%2Ffoto_detail%2F<?php echo rawurlencode($this->uri->segment(3));?>&amp;src=sdkpreparse"><i class="fa fa-facebook"></i></a></div></li>
        										<li><a style="padding-left: 9px;padding-right: 9px;" class="twitter customer share" href="https://twitter.com/share" target="_blank"><i class="fa fa-twitter"></i></a></li>
        										<li><a style="padding-left: 9px;padding-right: 9px;" class="google customer share" href="https://plus.google.com/share?url=<?php echo rawurlencode('http://suarakaryanews.com/index.php/berita/foto_detail/'.$this->uri->segment(3));?>" onclick="javascript:window.open(this.href,
          '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-google-plus"></i></a></li>
											...
											<div class="container padding-0">
												...
												<div class="advertisement advertisement-extends margin-bottom-0">
													<div class="desktop-advert img-full-width margin-0">
														...
														?>
														<img src="<?php echo base_url();?>uploads/advertise/original/<?php echo $pop->adv_pict;?>" alt="" style="width:100%;">
														<?php 
																}
															}
														?>
										...
										<div class="carousel-box owl-wrapper">
											<div class="title-section">
												<h1><span class="padding-top-20">Baca Juga</span></h1>
											</div>
