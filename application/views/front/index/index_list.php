			...
			$(function(){
				...
				$("#filter-date").change(
					function(){
						...
						$.ajax({
							url:"<?php echo base_url();?>index.php/berita/get_filter_index/",
							cache:false,
							data: {
							   filter : convdate,
							   kanal : kanal
							...
							success:function(result){
								...
								$.each(result, function(i, data){
									$('#grid-box-index .autor-list').append('<li>'+
										'<a href="http://suarakaryanews.com/index.php/berita/artikel/'+data.post_url+'" style="text-decoration:none;">'+
