	...
	<script>
		function loadReaction(){
			var url = '<?php echo $this->uri->segment(3);?>';
			 $.ajax({
				url:"<?php echo base_url();?>index.php/berita/get_reaction_video/",
				cache:false,
				data: {
				   url : url
				},
		...
		function loadCommentPost(){
			var url = '<?php echo $this->uri->segment(3);?>';
				 $.ajax({
					url:"<?php echo base_url();?>index.php/berita/get_comment_video/",
					cache:false,
					data: {
					   url : url
					},
	...
	<script>
		$(function() {
			...
			$('#senang-box').click(function(){
				var id_post = $("#post").val();
				 $.ajax({
					url:"<?php echo base_url();?>index.php/berita/set_reaction_video/",
					cache:false,
					data: {
					   reac : 'REA00001',
					   post : id_post
		...
		<div id="content-shared">
			<div class="sosmed-fixed">
				<ul>
					<li style="background:#1854dd;color:#fff;"><div style="width:100%;height:100%;margin:auto;display:flex;text-align:center;" data-href="<?php echo base_url().'index.php/berita/video_detail/'.$this->uri->segment(3);?>" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="facebook customer share" style="text-decoration:none;color:#fff;width:100%;display:flex;" class="fb-xfbml-parse-ignore" target="_blank"  href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fm.suarakaryanews.com%2Findex.php%2Fberita%2Fvideo_detail%2F<?php echo rawurlencode($this->uri->segment(3));?>&amp;src=sdkpreparse"><span class="fa fa-facebook fa-2x"></span></a></div></li>
					...
					<li style="background:#f14133;color:#fff;"><a style="width:100%;height:100%;text-align:center;display:flex;color:#fff;text-decoration:none;" class="google customer share" href="https://plus.google.com/share?url=<?php echo rawurlencode('http://m.suarakaryanews.com/index.php/berita/video_detail/'.$this->uri->segment(3));?>" onclick="javascript:window.open(this.href,
							...
							<div class="col-xs-12 col-sm-12 col-md-12 artikel-desc" style="background-color:#222;">
								...
								<div class="grid-box margin-bottom-5">
									<div class="title-section">
										<h1 style="text-transform:none;color:#fff;"><span><?php echo $title_main;?></span></h1>
									</div>
									...
									<div class="row margin-top-5">
										<div class="col-md-12">
											<div class="news-post video-post">
												...
												<a href="<?php echo $link;?>" class="video-link"><i class="fa fa-play-circle-o"></i></a>
												<div class="hover-box">
													<h2><a href="single-post.html"><?php echo $short_main;?></a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i><?php echo date('d M Y H:i', strtotime($date_main))?></li>
													</ul>
												</div>
											</div>
										</div>
								...
								<div class="block-content">
									...
									<div class="single-post-box">
										<div class="title-post margin-top-10 padding-full-0">
											<p style="font-size:12px;"><?php echo $desc_main;?></p>
											<ul class="post-tags">
        									...
        									<!-- Place this tag in your head or just before your close body tag. -->
        										<li><div data-href="<?php echo base_url().'index.php/berita/video_detail/'.$this->uri->segment(3);?>" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="facebook customer share" class="fb-xfbml-parse-ignore" target="_blank"  href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fsuarakaryanews.com%2Findex.php%2Fberita%2Fvideo_detail%2F<?php echo rawurlencode($this->uri->segment(3));?>&amp;src=sdkpreparse"><i class="fa fa-facebook"></i></a></div></li>
        										...
        										<li><a style="padding-left: 9px;padding-right: 9px;" class="google customer share" href="https://plus.google.com/share?url=<?php echo rawurlencode('http://suarakaryanews.com/index.php/berita/video_detail/'.$this->uri->segment(3));?>" onclick="javascript:window.open(this.href,
