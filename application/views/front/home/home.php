                ...
                if($(window).scrollTop() + $(window).height() == $(document).height()) {
                    ...
                    //$('#no-more').hide();
					  ...
					  if(first_a > 40){
                        ...
                        $.ajax({
                            //url:"../../beta/index.php/berita/get_data/",
						...
						<div class="sidebar" id="sidebar">
							...
							<div class="advertisement padding-full-0 img-adv-full">
								<div class="desktop-advert">
									...
									?>
									<a href="<?php echo $pop->adv_link;?>">
									        <img src="<?php echo base_url();?>uploads/advertise/original/<?php echo $pop->adv_pict;?>" class="img-full-width" alt="">
									</a>
									<?php 
											}
										}
