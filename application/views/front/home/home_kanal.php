                ...
                if($(window).scrollTop() + $(window).height() == $(document).height()) {
                    ...
                    //$('#no-more').hide();
					  ...
					  if(first_a > 40){
						...
						var first = $('#first').val();
						var limit = $('#limit').val();
						var kanal = '<?php echo $this->uri->segment(3);?>';
                        ...
                        $.ajax({
                            url:"../../get_data_kanal/",
							//url:"<?php echo base_url();?>/index.php/berita/get_data_kanal/",
							cache:false,
							data: {
							   start : first,
							   limit : limit,
						...
						<div class="block-content headline-news-box">
							...
							<div class="grid-box margin-0 margin-bottom-0">
								<div class="row widget-politik">
									<div class="col-xs-12 col-sm-3 col-md-2 head-news">
										<h1 class="headline-title">HEADLINE NEWS >></h1>
									</div>
									<div class="col-xs-12 col-sm-9 col-md-10 margin-0 padding-0">
										<!-- Carousel box -->
										<div class="carousel-box owl-wrapper">

											<div id="owl-cour" class="owl-carousel" data-num="3">
											<?php 
									...
									<ul class="bxslider">
										...
										<li>
											<div class="news-post image-post">
												<div class="img-full-width" style="height:510px;background-image:url('<?php echo base_url();?>uploads/post/original/<?php echo $main->post_thumb;?>');background-color:#333;background-size: auto 100%;background-position-x: 50%;background-repeat: no-repeat;"></div>
								...
								<div class="row" id="grid-haha">
									...
									<div class="col-xs-5 col-sm-4 col-md-4.5 padding-full-0 box-side">
										...
										<div id="warta-daerah">
												...
												<ul class="review-posts-list main-news-warta margin-bottom-5">
													...
													<li class="list-warta">
														<div class="box-list-warta">
															...
															<div class="box-list-desc">
																<h2 class="title-warta"><a class="hover" href="<?php echo base_url()?>index.php/berita/artikel/<?php echo $wrt->post_url;?>"><?php echo substr($wrt->post_title, 0,45);?></a></h2>
															</div>
														</div>
													</li>
													<?php
											...
											<div class="advertisement padding-full-0 img-adv-full" style="width:255px;">
												<div class="desktop-advert">
													<?php 
														foreach($query_adv->result() as $pop){
									...
									<div class="col-xs-7 col-sm-8 col-md-8 div-berita">
										<div class="margin-top-10 box-berita" id="content">
												...
												<div class="row">
													<div class="col-xs-4 col-sm-3 col-md-3 padding-right-0">
														<div class="post-gallery">
															<div class="background-img-berita" style="background-image:url('<?php echo base_url();?>uploads/post/original/<?php echo $list->post_thumb;?>');"></div>
											...
											<div class="news-post article-post list-regular margin-bottom-0 box1">
												<div class="row">
													<div class="col-xs-4 col-sm-3 col-md-3 padding-right-0">
														<div class="post-gallery">
															<div class="background-img-berita" style="background-image:url('<?php echo base_url();?>uploads/post/original/<?php echo $li->post_thumb;?>');"></div>
										...
										<div class="center-button margin-0 margin-top-10 margin-bottom-10">
											<a href="<?php echo base_url().'index.php/berita/key_index/'.$this->uri->segment(3)?>" id="no-more" class="no-more"><i class="fa fa-refresh"></i> More News</a>
