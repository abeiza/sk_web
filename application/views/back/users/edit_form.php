		...
		<div class="col s12 m12 l12">
			<div class="card">
				<div class="card-content">
					...
					<?php echo $error;?>
					<form enctype="multipart/form-data" action="<?php echo base_url();?>index.php/back/users/edit/<?php echo $this->uri->segment(4);?>" method="post">
					<div class="row">
						<div class="col m12">
							<div class="row">
								...
								<div class="col m12 s12">
									...
									<input id="username" name="username" type="text" class="required validate" value="<?php echo $username;?>" aria-required="true">
								</div>
								<div class="col m12 s12">
									...
									<input id="password" name="password" type="password" class="required validate" value="<?php echo $password;?>" aria-required="true">
								</div>
								<div class="col m12 s12">
