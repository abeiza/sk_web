		...
		<div class="col s12 m12 l12">
			<div class="card">
				<div class="card-content">
					...
					<?php echo $error;?>
					<form enctype="multipart/form-data" action="<?php echo base_url();?>index.php/back/posting/edit/<?php echo $this->uri->segment(4);?>" method="post">
					<div class="row">
						<div class="col m12" style="width:100%;">
							<div class="row">
								...
								<div class="col m12 s12" style="margin-top:30px;margin-bottom:10px;">
									<?php 
										if($pict2 == '' or $pict2 == null){
											...
											echo "<div style='margin-bottom:10px;width:100%;background-color:#f9f9f9;text-align:center;'><img src='".base_url()."uploads/post/original/".$pict2."' style='width:100%'/></div>";
								...
								<div class="col s12">
									<label for="pdf">Link Pdf</label>
									<textarea for="pdf" name="pdf"><?php echo $pdf;?></textarea>
								</div>
								<div class="col s12">
								...
								<div class="col s12">
									<a class="waves-effect waves-grey btn-flat" href="<?php echo base_url();?>index.php/back/posting/">Back</a>
