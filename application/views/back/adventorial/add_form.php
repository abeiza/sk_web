		...
		<div class="col s12 m12 l12">
			<div class="card">
				<div class="card-content">
					...
					<?php echo $error;?>
					<form enctype="multipart/form-data" action="<?php echo base_url();?>index.php/back/adventorial/add/" method="post">
					<div class="row">
						<div class="col m12">
							<div class="row">
								...
								<div class="col m12 s12">
									...
									<input id="direct" name="direct" type="text" class="required validate" aria-required="true">
								</div>
