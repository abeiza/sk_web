...
<main class="mn-inner" style="background-color:#f1f1f1 !important;">
	<div class="row">
		<div class="col s12">
			<div class="page-title"><h5>Layout Home</h5>
				<div class="row">
					<div class="col s5">
			...
			<div class="card">
				<div class="card-content" style="width:100%;height:2135px;float:left;background-color:#fff;">
					...
					<div style="width:12.5%;float:left;height:600px;">
						<?php if($get_left_img == ''){?>
							<div id='lbl-left-side' style="border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;"><span style="height:50px;margin: auto;font-size:12px;text-align:center"><strong style="color:#000">(Left Side Banner)</strong><br/>Click to Choose Banner<br/><strong id="get-left-side"></strong></span></div>
						<?php }else{?>
							<div id='lbl-left-side' style="background-position-x: center;background-position-y: center;background-size:contain;background-repeat:no-repeat;background-color:rgba(255,255,255,0.1);background-image:url('<?php echo base_url().'uploads/advertise/original/'.$get_left_img;?>');border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;">
								<div style="width:100%;height:100%;background-color:rgba(0,0,0,0.5);float:left;display:flex;margin:auto;">	
									<span style="height:50px;margin: auto;font-size:12px;color:#fff;text-align:center"><strong style="color:#fff">(Left Side Banner)</strong><br/>Click to Choose Banner<br/><strong id="get-left-side"></strong></span>
								</div>
							</div>
						<?php }?>
						<input type="hidden" id="left-side-banner"/>
					</div>
					...
					<div style="width:75%;float:left;height:450px;">
						...
						<div style="width:100%;float:left;height:96px;">
							<?php if($get_main_img == ''){?>
								<div id="lbl-main" style="border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;">
									<span style="height:40px;margin:auto;font-size:12px;text-align:center"><strong style="color:#000">(Main Banner)</strong><br/>Click to Choose Banner<br/><strong id="get-main-side"></strong></span>
								</div>
							<?php }else{?>
								<div id="lbl-main" style="background-position-x: center;background-position-y: center;background-size:contain;background-repeat:no-repeat;background-color:rgba(255,255,255,0.1);background-image:url('<?php echo base_url().'uploads/advertise/original/'.$get_main_img;?>');border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;">
									<div style="width:100%;height:100%;background-color:rgba(0,0,0,0.5);float:left;display:flex;margin:auto;">	
										<span style="height:40px;margin:auto;font-size:12px;text-align:center;color:#fff;"><strong style="color:#fff">(Main Banner)</strong><br/>Click to Choose Banner<br/><strong id="get-main-side"></strong></span>
									</div>
								</div>
							<?php }?>
						...
						<div style="width:100%;float:left;height:200px;">
							<div style="width:75%;height:100%;float:left;">
								...
								<div style="width:30%;float:left;">
									<div style="width:100%;float:left;height:200px;">
									<?php if($get_cleft1_img == ''){?>
										<div id="lbl-cleft1" style="border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;"><span style="height:20px;margin:auto;font-size:12px;text-align:center"><strong style="color:#000">(Left Content Banner 1)</strong><br/>Click to Choose Banner<br/><strong id="get-cleft1-side"></strong></span></div>
									<?php }else{?>
										<div id="lbl-cleft1" style="background-position-x: center;background-position-y: center;background-size:contain;background-repeat:no-repeat;background-color:rgba(255,255,255,0.1);background-image:url('<?php echo base_url().'uploads/advertise/original/'.$get_cleft1_img;?>');border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;">
											<div style="width:100%;height:100%;background-color:rgba(0,0,0,0.5);float:left;display:flex;margin:auto;">
												<span style="height:20px;margin:auto;font-size:12px;text-align:center;color:#fff;"><strong style="color:#fff">(Left Content Banner 1)</strong><br/>Click to Choose Banner<br/><strong id="get-cleft1-side"></strong></span>
											</div>
										</div>
									<?php }?>
										<input type="hidden" id="cleft1-banner"/>
									</div>
									<div style="width:100%;float:left;height:200px;">
									<?php if($get_cleft2_img == ''){?>
										<div id="lbl-cleft2" style="border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;"><span style="height:20px;margin:auto;font-size:12px;text-align:center"><strong style="color:#000">(Left Content Banner 2)</strong><br/>Click to Choose Banner<br/><strong id="get-cleft2-side"></strong></span></div>
									<?php }else{?>
										<div id="lbl-cleft2" style="background-position-x: center;background-position-y: center;background-size:contain;background-repeat:no-repeat;background-color:rgba(255,255,255,0.1);background-image:url('<?php echo base_url().'uploads/advertise/original/'.$get_cleft2_img;?>');border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;">
											<div style="width:100%;height:100%;background-color:rgba(0,0,0,0.5);float:left;display:flex;margin:auto;">	
												<span style="height:20px;margin:auto;font-size:12px;text-align:center;color:#fff;"><strong style="color:#fff">(Left Content Banner 2)</strong><br/>Click to Choose Banner<br/><strong id="get-cleft2-side"></strong>
												</span>
											</div>
										</div>
									<?php }?>
										<input type="hidden" id="cleft2-banner"/>
									</div>
									<div style="width:100%;float:left;height:200px;">
									<?php if($get_cleft3_img == ''){?>
										<div id="lbl-cleft3" style="border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;"><span style="height:20px;margin:auto;font-size:12px;text-align:center"><strong style="color:#000">(Left Content Banner 3)</strong><br/>Click to Choose Banner<br/><strong id="get-cleft3-side"></strong></span></div>
									<?php }else{?>
										<div id="lbl-cleft3" style="background-position-x: center;background-position-y: center;background-size:contain;background-repeat:no-repeat;background-color:rgba(255,255,255,0.1);background-image:url('<?php echo base_url().'uploads/advertise/original/'.$get_cleft3_img;?>');border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;">
											<div style="width:100%;height:100%;background-color:rgba(0,0,0,0.5);float:left;display:flex;margin:auto;">
												<span style="height:20px;margin:auto;font-size:12px;text-align:center;color:#fff;"><strong style="color:#fff">(Left Content Banner 3)</strong><br/>Click to Choose Banner<br/><strong id="get-cleft3-side"></strong></span>
											</div>
										</div>
									<?php }?>
										<input type="hidden" id="cleft3-banner"/>
									</div>
								</div>
								<div style="width:70%;float:left;">
									<div style="width:100%;background-color:#f1f1f1;height:600px;float:left;"></div>
								</div>
								<div style="width:100%;float:left;height:360px;">
									<?php if($get_pop_img == ''){?>
										<div id="lbl-pop" style="border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;"><span style="height:50px;margin: auto;font-size:12px;text-align:center"><strong style="color:#000">(Pop Up Banner)</strong><br/>Click to Choose Banner<br/><strong id="get-pop-side"></strong></span></div>
									<?php }else{?>
										<div id="lbl-pop" style="background-position-x: center;background-position-y: center;background-size:contain;background-repeat:no-repeat;background-color:rgba(255,255,255,0.1);background-image:url('<?php echo base_url().'uploads/advertise/original/'.$get_pop_img;?>');border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;">
											<div style="width:100%;height:100%;background-color:rgba(0,0,0,0.5);float:left;display:flex;margin:auto;">
												<span style="height:50px;margin: auto;font-size:12px;text-align:center;color:#fff"><strong style="color:#fff">(Pop Up Banner)</strong><br/>Click to Choose Banner<br/><strong id="get-pop-side"></strong></span>
											</div>
										</div>
									<?php }?>
									<input type="hidden" id="pop-banner"/>
								</div>
					...
					<div style="width:12.5%;float:left;height:600px;">
						<?php if($get_right_img == ''){?>
							<div id="lbl-right-side" style="border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;"><span style="height:50px;margin: auto;font-size:12px;text-align:center"><strong style="color:#000">(Right Side Banner)</strong><br/>Click to Choose Banner<br/><strong id="get-right-side"></strong></span></div>
						<?php }else{?>
							<div id="lbl-right-side" style="background-position-x: center;background-position-y: center;background-size:contain;background-repeat:no-repeat;background-color:rgba(255,255,255,0.1);background-image:url('<?php echo base_url().'uploads/advertise/original/'.$get_right_img;?>');border:1px dotted #f1f1f1;width:100%;height:100%;float:left;display:flex;margin:auto;">
								<div style="width:100%;height:100%;background-color:rgba(0,0,0,0.5);float:left;display:flex;margin:auto;">
									<span style="height:40px;margin:auto;font-size:12px;color:#fff;text-align:center"><strong style="color:#fff">(Right Side Banner)</strong><br/>Click to Choose Banner<br/><strong id="get-right-side"></strong></span>
								</div>
							</div>
						<?php }?>
						<input type="hidden" id="right-side-banner"/>
					</div>
...
<div style="width:100%;position:fixed;height:100%;top:0;left:0;background-color:rgba(255,255,255,0.1);z-index:9999;" id="bg-pop">
	<div id="left-pop" style="width:30%;padding:30px;text-align:center;height:230px;background-color:#fff;margin:auto;box-shadow:0 2px 2px 0 rgba(0,0,0,.19), 0 3px 1px -2px rgba(0,0,0,.19), 0 1px 5px 0 rgba(0,0,0,.19);">
		...
		<select for="kanal" id="select-top-pop" name="selected_id">
			<option value="" disabled selected>Layout Data</option>
			<?php 
				foreach($get_list_left->result() as $left){
			?>
				<option value="<?php echo $left->adv_id;?>" <?php echo $left->adv_id == $get_left?'selected':'';?>><?php echo $left->adv_title;?></option>
			<?php
				}
			?>
			<option value="clear">Clear</option>
		</select>
		<input type="hidden" name="position_id" value='PSB00003'/>
	...
	<div id="right-pop" style="width:30%;padding:30px;text-align:center;height:230px;background-color:#fff;margin:auto;box-shadow:0 2px 2px 0 rgba(0,0,0,.19), 0 3px 1px -2px rgba(0,0,0,.19), 0 1px 5px 0 rgba(0,0,0,.19);">
		...
		<select for="kanal" id="select-top-pop" name="selected_id">
			<option value="" disabled selected>Layout Data</option>
			<?php 
				foreach($get_list_right->result() as $right){
			?>
				<option value="<?php echo $right->adv_id;?>" <?php echo $right->adv_id == $get_right?'selected':'';?>><?php echo $right->adv_title;?></option>
			<?php
				}
			?>
			<option value="clear">Clear</option>
		</select>
		<input type="hidden" name="position_id" value='PSB00004'/>
		<button type="submit" class="waves-effect waves-light btn teal" id="btn-top-pop">Selected</button>
		<?php echo form_close();?>
	</div>
	...
	<div id="cleft1-pop" style="width:30%;padding:30px;text-align:center;height:230px;background-color:#fff;margin:auto;box-shadow:0 2px 2px 0 rgba(0,0,0,.19), 0 3px 1px -2px rgba(0,0,0,.19), 0 1px 5px 0 rgba(0,0,0,.19);">
		...
		<select for="kanal" id="select-top-pop" name="selected_id">
			<option value="" disabled selected>Layout Data</option>
			<?php 
				foreach($get_list_cleft1->result() as $cleft1){
			?>
				<option value="<?php echo $cleft1->adv_id;?>" <?php echo $cleft1->adv_id == $get_cleft1?'selected':'';?>><?php echo $cleft1->adv_title;?></option>
			<?php
				}
			?>
			<option value="clear">Clear</option>
		</select>
		<input type="hidden" name="position_id" value='PSB00005'/>
		<button type="submit" class="waves-effect waves-light btn teal" id="btn-top-pop">Selected</button>
		<?php echo form_close();?>
	</div>
	...
	<div id="cleft2-pop" style="width:30%;padding:30px;text-align:center;height:230px;background-color:#fff;margin:auto;box-shadow:0 2px 2px 0 rgba(0,0,0,.19), 0 3px 1px -2px rgba(0,0,0,.19), 0 1px 5px 0 rgba(0,0,0,.19);">
		...
		<select for="kanal" id="select-top-pop" name="selected_id">
			<option value="" disabled selected>Layout Data</option>
			<?php 
				foreach($get_list_cleft2->result() as $cleft2){
			?>
				<option value="<?php echo $cleft2->adv_id;?>" <?php echo $cleft2->adv_id == $get_cleft2?'selected':'';?>><?php echo $cleft2->adv_title;?></option>
			<?php
				}
			?>
			<option value="clear">Clear</option>
		</select>
		<input type="hidden" name="position_id" value='PSB00006'/>
		<button type="submit" class="waves-effect waves-light btn teal" id="btn-top-pop">Selected</button>
		<?php echo form_close();?>
	</div>
	...
	<div id="cleft3-pop" style="width:30%;padding:30px;text-align:center;height:230px;background-color:#fff;margin:auto;box-shadow:0 2px 2px 0 rgba(0,0,0,.19), 0 3px 1px -2px rgba(0,0,0,.19), 0 1px 5px 0 rgba(0,0,0,.19);">
		...
		<select for="kanal" id="select-top-pop" name="selected_id">
			<option value="" disabled selected>Layout Data</option>
			<?php 
				foreach($get_list_cleft3->result() as $cleft3){
			?>
				<option value="<?php echo $cleft3->adv_id;?>" <?php echo $cleft3->adv_id == $get_cleft3?'selected':'';?>><?php echo $cleft3->adv_title;?></option>
			<?php
				}
			?>
			<option value="clear">Clear</option>
		</select>
		<input type="hidden" name="position_id" value='PSB00007'/>
		<button type="submit" class="waves-effect waves-light btn teal" id="btn-top-pop">Selected</button>
		<?php echo form_close();?>
	</div>
	...
	<div id="pop-pop" style="width:30%;padding:30px;text-align:center;height:230px;background-color:#fff;margin:auto;box-shadow:0 2px 2px 0 rgba(0,0,0,.19), 0 3px 1px -2px rgba(0,0,0,.19), 0 1px 5px 0 rgba(0,0,0,.19);">
		...
		<select for="kanal" id="select-top-pop" name="selected_id">
			<option value="" disabled selected>Layout Data</option>
			<?php 
				foreach($get_list_pop->result() as $pop){
			?>
				<option value="<?php echo $pop->adv_id;?>" <?php echo $pop->adv_id == $get_pop?'selected':'';?>><?php echo $pop->adv_title;?></option>
			<?php
				}
			?>
			<option value="clear">Clear</option>
		</select>
		<input type="hidden" name="position_id" value='PSB00011'/>
		<button type="submit" class="waves-effect waves-light btn teal" id="btn-top-pop">Selected</button>
		<?php echo form_close();?>
	</div>
