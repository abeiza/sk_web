		...
		<div class="col s12 m12 l12">
			<div class="card">
				<div class="card-content">
					...
					<form action="<?php echo base_url();?>index.php/back/category/edit/<?php echo $this->uri->segment(4);?>" method="post">
					<div class="row">
						<div class="col m12">
							<div class="row">
								...
								<div class="col s12">
									...
									<select for="kanal" name="kanal">
										...
										?>
											<option value='<?php echo $ctg->kanal_id;?>' <?php echo $kanal == $ctg->kanal_id?'selected':'';?>><?php echo $ctg->kanal_name;?></option>";
										<?php
										}
											}
										?>
