	...
	class Berita extends CI_Controller{
		...
		function index(){
			...
			if($cek){
				...
				$qry_sosmed = $this->db->query("select * from sk_sosmed");
				if($qry_sosmed->num_rows() == 0){
				    $ft['link_fb'] = '';
			        $ft['link_tw'] = '';
			        $ft['link_in'] = '';
			        $ft['link_gp'] = '';
				    ...
				    foreach($qry_sosmed->result() as $smd){
				        $ft['link_fb'] = $smd->sosmed_facebook;
				        $ft['link_tw'] = $smd->sosmed_twitter;
				        $ft['link_in'] = $smd->sosmed_instagram;
				        $ft['link_gp'] = $smd->sosmed_google;
				        $ft['link_yt'] = $smd->sosmed_youtube;
				    }    
				}
				...
				$this->load->view('front/global/footer',$ft);
		...
		function sosmed(){
			...
			if($cek){
                ...
                if(!empty($userID)){
                    $data['userData'] = $userData;
                    $this->session->set_userdata('userData',$userData);
                    Header("Location:".$this->session->userdata('current_d'));
                }else{
                   //$data['userData'] = array();
		...
		function sosmedG(){
    		...
    		$clientId = '669121716175-6im0a9uru5gkrqtshcjvdj3pg4k865k3.apps.googleusercontent.com';
            $clientSecret = 'CnEgeiykCgZTImIH6_sVFVUD';
            $redirectUrl = base_url() . 'index.php/berita/sosmedG/';
		...
		function loginFacebook($uri1,$uri2,$uri3,$uri4){
		    $url_fb = $this->facebook->login_url();
		    $uri1 = $this->uri->segment(3);
		    $uri2 = $this->uri->segment(4);
		    $uri3 = $this->uri->segment(5);
		    $uri4 = $this->uri->segment(6);
		    if($uri4 != 'none'){
			    $url_redirect = base_url().'index.php/'.$uri1.'/'.$uri2.'/'.$uri3.'/'.$uri4.'/';
			}else if($uri2 == 'none'){
			     $url_redirect = base_url().'index.php/'.$uri1.'/';
			}else if($uri3 == 'none'){
			    $url_redirect = base_url().'index.php/'.$uri1.'/'.$uri2.'/';
			}else{
			    $url_redirect = base_url().'index.php/'.$uri1.'/'.$uri2.'/'.$uri3.'/';
			}
			
			$this->session->unset_userdata('current_d');
		    //$current_d = $this->session->set_userdata('current_d',$url_redirect);
		    $sess['current_d'] = $url_redirect;
			$this->session->set_userdata($sess);
			
			$currentd = $this->session->userdata('current_d');
		    if($currentd){
		        Header("Location:".$this->facebook->login_url());
		    }else{
		        Header("Location:".base_url());
		    }
		    //echo $this->session->userdata('current_d');
		}
		
		function loginGoogle($uri1,$uri2,$uri3,$uri4){
		    include_once APPPATH."libraries/google-api-php-client/Google_Client.php";
		    include_once APPPATH."libraries/google-api-php-client/contrib/Google_Oauth2Service.php";
		    // Google Project API Credentials
    		$clientId = '669121716175-6im0a9uru5gkrqtshcjvdj3pg4k865k3.apps.googleusercontent.com';
		    ...
		    $url_google = $this->facebook->login_url();
		    $uri1 = $this->uri->segment(3);
		    $uri2 = $this->uri->segment(4);
		    $uri3 = $this->uri->segment(5);
		    $uri4 = $this->uri->segment(6);
		...
		function artikel($id){
			...
			if($cek){
				...
				$this->load->view('front/global/footer',$ft);
				$this->load->view('front/global/bottom_article_1024');
			}else if($this->facebook->is_authenticated()){
		...
		function get_filter_pdf(){
			...
			if($kanal == 'none'){
				$query_filter = $this->db->query("select sk_post.post_title, sk_post.post_url, sk_post.post_modify_date, sk_category.category_name from sk_post, sk_category, sk_kanal where sk_post.category_id = sk_category.category_id and sk_category.kanal_id = sk_kanal.kanal_id and year(sk_post.post_modify_date) = '".date('Y',strtotime($filter))."' and month(sk_post.post_modify_date) = '".date('m',strtotime($filter))."' and day(sk_post.post_modify_date) = '".date('d',strtotime($filter))."' and sk_post.flag_id = 'FLG00002' and sk_post.post_status='1' and (sk_post.post_pdf != null or sk_post.post_pdf != '') order by sk_post.post_modify_date desc");
			}else{
				$query_filter = $this->db->query("select sk_post.post_title, sk_post.post_url, sk_post.post_modify_date, sk_category.category_name from sk_post, sk_category, sk_kanal where sk_post.category_id = sk_category.category_id and sk_category.kanal_id = sk_kanal.kanal_id and sk_kanal.kanal_name = '".$kanal."' and year(sk_post.post_modify_date) = '".date('Y',strtotime($filter))."' and month(sk_post.post_modify_date) = '".date('m',strtotime($filter))."' and day(sk_post.post_modify_date) = '".date('d',strtotime($filter))."' and sk_post.flag_id = 'FLG00002' and sk_post.post_status='1' and (sk_post.post_pdf != null or sk_post.post_pdf != '') order by sk_post.post_modify_date desc");
			}
			$data_list_a = array();
		...
		function video_detail($id){
			...
			if($cek){
				...
				$this->load->view('front/global/footer',$ft);
				$this->load->view('front/global/bottom_video_1024');
			}else if($this->facebook->is_authenticated()){
		...
		function foto_detail($id){
			...
			if($cek){
				...
				$this->load->view('front/global/footer',$ft);
				$this->load->view('front/global/bottom_pict_1024');
			}else if($this->facebook->is_authenticated()){
		...
		function pdf($kanal){
			...
			if($cek){
				...
				if($artikel == 'artikel'){
					...
					$data['get_commended'] = $this->db->query("SELECT post_title, post_url, post_modify_date, count(sk_comment.post_id) as c_comment FROM `sk_comment`, sk_post where sk_post.post_id = sk_comment.post_id group by sk_comment.post_id and sk_post.flag_id = 'FLG00002' and sk_post.post_status ='1' order by c_comment desc limit 10");
					$data['get_sorot'] = $this->db->query("select tag_name, count(counter_uri) as c_counter from sk_tag, sk_post, sk_log_counter where sk_tag.tag_id = sk_post.tag_id and sk_post.post_url = sk_log_counter.counter_uri and sk_post.flag_id = 'FLG00002' and sk_tag.tag_status ='1' group by tag_name order by c_counter desc limit 10");
					$data['get_index'] = $this->db->query("select sk_post.post_title, sk_post.post_url, sk_post.post_modify_date, sk_category.category_name from sk_post, sk_category, sk_kanal where sk_post.category_id = sk_category.category_id and sk_category.kanal_id = sk_kanal.kanal_id and year(sk_post.post_modify_date) = '".date('Y')."' and month(sk_post.post_modify_date) = '".date('m')."' and day(sk_post.post_modify_date) = '".date('d')."' and sk_post.flag_id = 'FLG00002' and sk_post.post_status ='1' and (sk_post.post_pdf != '' or sk_post.post_pdf != null) order by sk_post.post_modify_date desc");
					...
					$data['get_commended'] = $this->db->query("SELECT post_title, post_url, post_modify_date, count(sk_comment.post_id) as c_comment FROM `sk_comment`, sk_post where sk_post.post_id = sk_comment.post_id and sk_post.flag_id = 'FLG00002' and sk_post.post_status ='1' group by sk_comment.post_id order by c_comment desc limit 10");
					$data['get_sorot'] = $this->db->query("select tag_name, count(counter_uri) as c_counter from sk_tag, sk_post, sk_log_counter where sk_tag.tag_id = sk_post.tag_id and sk_post.post_url = sk_log_counter.counter_uri and sk_post.flag_id = 'FLG00002' and sk_tag.tag_status ='1' group by tag_name order by c_counter desc limit 10");
					$data['get_index'] = $this->db->query("select sk_post.post_title, sk_post.post_url, sk_post.post_modify_date, sk_category.category_name from sk_post, sk_category, sk_kanal where sk_post.category_id = sk_category.category_id and sk_category.kanal_id = sk_kanal.kanal_id and sk_kanal.kanal_name = '".$kanal."' and year(sk_post.post_modify_date) = '".date('Y')."' and month(sk_post.post_modify_date) = '".date('m')."' and day(sk_post.post_modify_date) = '".date('d')."'  and sk_post.flag_id = 'FLG00002' and sk_post.post_status ='1' and (sk_post.post_pdf != '' or sk_post.post_pdf != null) order by sk_post.post_modify_date desc");
				...
				$this->load->view('front/global/top-logged_other',$data);
				$this->load->view('front/global/header',$data);
				$this->load->view('front/pdf/download_pdf',$data);
				$this->load->view('front/global/footer',$ft);
				$this->load->view('front/global/bottom');
			}else if($this->facebook->is_authenticated()){
				...
				if($artikel == 'artikel'){
					...
					$data['get_commended'] = $this->db->query("SELECT post_title, post_url, post_modify_date, count(sk_comment.post_id) as c_comment FROM `sk_comment`, sk_post where sk_post.post_id = sk_comment.post_id group by sk_comment.post_id order by c_comment desc limit 10");
					$data['get_sorot'] = $this->db->query("select tag_name, count(counter_uri) as c_counter from sk_tag, sk_post, sk_log_counter where sk_tag.tag_id = sk_post.tag_id and sk_post.post_url = sk_log_counter.counter_uri group by tag_name order by c_counter desc limit 10");
					$data['get_index'] = $this->db->query("select sk_post.post_title, sk_post.post_url, sk_post.post_modify_date, sk_category.category_name from sk_post, sk_category, sk_kanal where sk_post.category_id = sk_category.category_id and sk_category.kanal_id = sk_kanal.kanal_id and year(sk_post.post_modify_date) = '".date('Y')."' and month(sk_post.post_modify_date) = '".date('m')."' and day(sk_post.post_modify_date) = '".date('d')."' and sk_post.flag_id = 'FLG00002' and (sk_post.post_pdf != '' or sk_post.post_pdf != null) order by sk_post.post_modify_date desc");
					...
					$data['get_commended'] = $this->db->query("SELECT post_title, post_url, post_modify_date, count(sk_comment.post_id) as c_comment FROM `sk_comment`, sk_post where sk_post.post_id = sk_comment.post_id group by sk_comment.post_id order by c_comment desc limit 10");
					$data['get_sorot'] = $this->db->query("select tag_name, count(counter_uri) as c_counter from sk_tag, sk_post, sk_log_counter where sk_tag.tag_id = sk_post.tag_id and sk_post.post_url = sk_log_counter.counter_uri group by tag_name order by c_counter desc limit 10");
					$data['get_index'] = $this->db->query("select sk_post.post_title, sk_post.post_url, sk_post.post_modify_date, sk_category.category_name from sk_post, sk_category, sk_kanal where sk_post.category_id = sk_category.category_id and sk_category.kanal_id = sk_kanal.kanal_id and sk_kanal.kanal_name = '".$kanal."' and year(sk_post.post_modify_date) = '".date('Y')."' and month(sk_post.post_modify_date) = '".date('m')."' and day(sk_post.post_modify_date) = '".date('d')."' and sk_post.flag_id = 'FLG00002' and (sk_post.post_pdf != '' or sk_post.post_pdf != null) order by sk_post.post_modify_date desc");
